...
ano_escolhido = st.selectbox("📅 Filtrar por ano", anos_disponiveis)
...
dia_filtro = st.selectbox("📅 Filtrar por dia", dias_disponiveis)
...
col2.metric("🧍‍♂️ Clientes únicos", clientes_unicos)
...
if not df_func.empty:
    ...
    st.info(f"📅 Dia com mais atendimentos: **{dia_max}** com **{qtd_max} atendimentos**")
...
st.subheader("📆 Média de atendimentos por dia do mês")
