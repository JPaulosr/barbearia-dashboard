...
# Recupera nome do cliente via session_state ou selectbox
cliente = st.session_state.get("cliente")

if not cliente:
    st.warning("⚠ Nenhum cliente selecionado via botão. Selecione manualmente:")
    clientes_unicos = sorted(df["Cliente"].dropna().unique())
    cliente = st.selectbox("🔎 Escolha um cliente", clientes_unicos)
