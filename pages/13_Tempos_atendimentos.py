...
with st.expander("📋 Visualizar dados consolidados"):
    st.dataframe(df_tempo, use_container_width=True)   os graficos de tempo nao esta em ordem crecente e os Insights nao tem nenum registro, eu tenho registros de ontem cadastrados
